    ...
    <footer className="bg-gray-50 border-t border-gray-200 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <h4 className="font-bold text-textPrimary mb-4">Liens rapides</h4>
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li><a href="https://app.profolib.fr" target="_blank" rel="noopener noreferrer" className="hover:text-primary">Connexion</a></li>
              <li><a href="#" className="hover:text-primary">Contact</a></li>
            </ul>
          </div>

          <div>
            <h4 className="font-bold text-textPrimary mb-4">Suivez-nous</h4>
            <div className="flex space-x-4">
              {/* Dummy social icons */}
              <div className="w-8 h-8 bg-gray-200 rounded-full hover:bg-primary hover:text-white transition-colors cursor-pointer flex items-center justify-center">
